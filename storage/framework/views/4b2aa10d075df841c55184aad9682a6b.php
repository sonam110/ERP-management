            ...
            custthemedark.addEventListener("click", function() {
                if (custthemedark.checked) {
                    ...
                    $('.dash-sidebar .main-logo a img').attr('src',
                        '<?php echo e(isset($logo_light) && !empty($logo_light) ? $logo . $logo_light : $logo . '/logo-light.png'); ?>'
                        );
                    ...
                    $('.dash-sidebar .main-logo a img').attr('src',
                        '<?php echo e(isset($logo_light) && !empty($logo_light) ? $logo . $logo_light : $logo . '/logo-dark.png'); ?>'
                        );
                    ...
                    <div class="card sticky-top" style="top:30px">
                        <div class="list-group list-group-flush" id="useradd-sidenav">
                            ...
                            <a href="#chat-gpt-settings"
                                class="list-group-item list-group-item-action border-0"><?php echo e(__('Chat GPT Settings')); ?>
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div class="form-check form-switch custom-switch-v1">
                                                                        ...
                                                                        <input type="checkbox"
                                                                            ...
                                                                            <?php echo e(isset($admin_payment_setting['tap_payment_is_on']) && $admin_payment_setting['tap_payment_is_on'] == 'on' ? 'checked="checked"' : ''); ?>>
                                                                    </div>
                                                                </div>
                                                            </button>
                                                        </h2>
                                                                ...
                                                                <div class="row pt-2">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <?php echo e(Form::text('company_tap_secret_key', isset($admin_payment_setting['company_tap_secret_key']) ? $admin_payment_setting['company_tap_secret_key'] : '', ['class' => 'form-control', 'placeholder' => __('Secret Key')])); ?><br>
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div class="form-check form-switch custom-switch-v1">
                                                                        ...
                                                                        <input type="checkbox"
                                                                            ...
                                                                            <?php echo e(isset($admin_payment_setting['authorizenet_payment_is_on']) && $admin_payment_setting['authorizenet_payment_is_on'] == 'on' ? 'checked="checked"' : ''); ?>>
                                                                    </div>
                                                                </div>
                                                            </button>
                                                        </h2>
                                                                            ...
                                                                            <div class="form-check">
                                                                                <label class="form-check-label text-dark">
                                                                                    <input type="radio"
                                                                                        ...
                                                                                        value="sandbox"
                                                                                        class="form-check-input"
                                                                                        <?php echo e((isset($admin_payment_setting['company_authorizenet_mode']) && $admin_payment_setting['company_authorizenet_mode'] == '') || (isset($admin_payment_setting['company_authorizenet_mode']) && $admin_payment_setting['company_authorizenet_mode'] == 'sandbox') ? 'checked="checked"' : ''); ?>>
                                                                                    <?php echo e(__('Sandbox')); ?>
                                                                            ...
                                                                            <div class="form-check">
                                                                                <label class="form-check-label text-dark">
                                                                                    <input type="radio"
                                                                                        ...
                                                                                        value="live"
                                                                                        class="form-check-input"
                                                                                        <?php echo e(isset($admin_payment_setting['company_authorizenet_mode']) && $admin_payment_setting['company_authorizenet_mode'] == 'live' ? 'checked="checked"' : ''); ?>>
                                                                                    <?php echo e(__('Production')); ?>
                                                                ...
                                                                <div class="row pt-2">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <?php echo e(Form::text('company_authorizenet_client_id', isset($admin_payment_setting['company_authorizenet_client_id']) ? $admin_payment_setting['company_authorizenet_client_id'] : '', ['class' => 'form-control', 'placeholder' => __('Merchant Login Id')])); ?><br>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <?php echo e(Form::text('company_authorizenet_secret_key', isset($admin_payment_setting['company_authorizenet_secret_key']) ? $admin_payment_setting['company_authorizenet_secret_key'] : '', ['class' => 'form-control', 'placeholder' => __('Merchant Transaction Key')])); ?><br>
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div class="form-check form-switch custom-switch-v1">
                                                                        ...
                                                                        <input type="checkbox"
                                                                            ...
                                                                            <?php echo e(isset($admin_payment_setting['khalti_payment_is_on']) && $admin_payment_setting['khalti_payment_is_on'] == 'on' ? 'checked="checked"' : ''); ?>>
                                                                    </div>
                                                                </div>
                                                            </button>
                                                        </h2>
                                                                ...
                                                                <div class="row pt-2">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <?php echo e(Form::text('khalti_public_key', isset($admin_payment_setting['khalti_public_key']) ? $admin_payment_setting['khalti_public_key'] : '', ['class' => 'form-control', 'placeholder' => __('Public Key')])); ?><br>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <?php echo e(Form::text('khalti_secret_key', isset($admin_payment_setting['khalti_secret_key']) ? $admin_payment_setting['khalti_secret_key'] : '', ['class' => 'form-control', 'placeholder' => __('Secret Key')])); ?><br>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Work\www\erpgo-saas\main-file\resources\views/settings/index.blade.php ENDPATH**/ ?>