                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <?php echo Form::text('phone', old('phone'), ['class' => 'form-control' , 'required' => 'required' ,'placeholder'=>'Enter employee phone'  ]); ?>
                            ...
                            <div class="form-group">
                                <?php echo e(Form::label('role', __('Employee Role'), ['class' => 'form-label'])); ?><span class="text-danger pl-1">*</span>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                ...
                                <?php echo Form::textarea('address', old('address'), ['class' => 'form-control', 'rows' => 2 ,'placeholder'=>'Enter employee address' , 'required' => 'required']); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-icon-user">
                                        <?php echo e(Form::select('branch_id', $branches, null, ['class' => 'form-control select2', 'placeholder' => 'Select Branch','required' => 'required'])); ?>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-icon-user">
                                        <?php echo e(Form::select('department_id', $departments, null, ['class' => 'form-control select2', 'id' => 'department_id' , 'placeholder' => 'Select Department','required' => 'required'])); ?>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-icon-user">                                    
                                        <?php echo e(Form::select('designation_id', $designations, null, ['class' => 'form-control select2', 'id' => 'designation_id' , 'placeholder' => 'Select Designation','required' => 'required'])); ?>
