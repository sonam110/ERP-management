            ...
            <div class="card emp_details">
                ...
                <div class="card-body employee-detail-edit-body">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <?php echo Form::select('role', $roles, $role_d->id,array('class' => 'form-control select','required'=>'required')); ?>
                    ...
                    <div class="card-body employee-detail-edit-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <?php echo Form::text('biometric_emp_id', null, [
                                    'class' => 'form-control',
                                    ...
                                    <div class="float-right col-4">
                                        ...
                                        <div class="choose-file form-group">
                                            <label for="document[<?php echo e($document->id); ?>]">
                                                <input class="form-control file-validate <?php if(!empty($employeedoc[$document->id])): ?> float-left <?php endif; ?> <?php $__errorArgs = ['document'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
