<div class="card sticky-top" style="top:30px">
    <div class="list-group list-group-flush" id="useradd-sidenav">
        ...
        <!-- Sonam -->
         <a href="<?php echo e(route('assetmaster.index')); ?>" class="list-group-item list-group-item-action border-0 <?php echo e(request()->is('assetmaster*') ? 'active' : ''); ?>"><?php echo e(__('Asset Master')); ?><div class="float-end"><i class="ti ti-chevron-right"></i></div></a>

    </div>
</div>
<?php /**PATH E:\WORK\www\nrtgo-erp-saas\resources\views/layouts/hrm_setup.blade.php ENDPATH**/ ?>