            ...
            <div class="table-responsive">
                <table class="table datatable">
                    <?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><h6><?php echo e($plan->name); ?> (<?php echo e(isset($admin_payment_setting['currency']) ? $admin_payment_setting['currency'] : '$'); ?><?php echo e($plan->price); ?>) <?php echo e(' / '. $plan->duration); ?></h6></td>
...
<?php /**PATH E:\WORK\www\nrtgo-erp-saas\resources\views/user/plan.blade.php ENDPATH**/ ?>