...
Route::group(['middleware' => ['verified']], function () {
    ...
    /*-----Lead Filter*/
    Route::get('/leads/filtered', [LeadController::class, 'filtered'])->name('leads.filtered');
    ...
    /*-------Lead Follow Up--------------------*/
    Route::get('lead_follow_up/{id}/', [LeadController::class, 'leadFollowUp'])->name('leads.follow_up')->middleware(['auth']);

     Route::get('/leads/{id}/follow_up/{fid}/edit', [LeadController::class, 'followupEdit'])->name('leads.follow_up.edit')->middleware(['auth', 'XSS']);

    Route::post('leads/{id}/followup', [LeadController::class, 'followUpStore'])->name('leads.follow_up.store')->middleware(['auth']);

     Route::put('/leads/{id}/followup/{fid}', [LeadController::class, 'followUpUpdate'])->name('leads.follow_up.update')->middleware(['auth']);

     Route::delete('/leads/{id}/followup/{fid}', [LeadController::class, 'followUpDestroy'])->name('leads.follou_up.destroy')->middleware(['auth', 'XSS']);
    // end Leads Module
