                                                ...
                                                @if(Auth::user()->type != 'client')
                                                    <div class="btn-group card-option">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            @can('edit lead')
                                                                <a href="#!" data-size="md" data-url="{{ URL::to('leads/'.$lead->id.'/labels') }}" data-ajax-popup="true" class="dropdown-item" data-bs-original-title="{{__('Add Labels')}}">
                                                                ...
                                                                <a href="#!" data-size="lg" data-url="{{ URL::to('leads/'.$lead->id.'/edit') }}" data-ajax-popup="true" class="dropdown-item" data-bs-original-title="{{__('Edit Lead')}}">
                                                                 ...
                                                                 <a href="#!" data-size="lg" data-url="{{ URL::to('lead_follow_up/'.$lead->id.'') }}" data-ajax-popup="true" class="dropdown-item" data-bs-original-title="{{__('Add Follow Up')}}">
                                                                    <i class="ti ti-plus"></i>
                                                                    <span>{{__('Add Follow Up')}}</span>
                                                                </a>
                                                            @endcan
                                                            @can('delete lead')
