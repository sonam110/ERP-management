            ...
            <div class="card emp_details">
                ...
                <div class="card-body employee-detail-edit-body">
                    ...
                    <div class="form-group col-md-12">
                        {{ Form::label('role', __('Employee Role'),['class'=>'form-label']) }}<span class="text-danger pl-1">*</span>
                        {!! Form::select('role', $roles, $role_d->id,array('class' => 'form-control select','required'=>'required')) !!}
                        @error('role')
