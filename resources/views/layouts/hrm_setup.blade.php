<div class="card sticky-top" style="top:30px">
    <div class="list-group list-group-flush" id="useradd-sidenav">
        ...
        <!-- Sonam -->
         <a href="{{ route('assetmaster.index') }}" class="list-group-item list-group-item-action border-0 {{ request()->is('assetmaster*') ? 'active' : '' }}">{{__('Asset Master')}}<div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
