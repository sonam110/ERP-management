...
class AssetController extends Controller
{
    ...
    public function create()
    {
        if(\Auth::user()->can('create assets'))
        {
            ...
            return view('assets.create',compact('employee','assetMasters'));
        }
        else
        {
            return redirect()->back()->with('error', __('Permission denied.'));
...
//        dd($request->all());
        if(\Auth::user()->can('create assets'))
        {
            ...
            $assets->asset_master_id           = $request->asset_master_id;
            $assets->assign_quantity           = $request->assign_quantity;
    ...
    public function edit($id)
    {
        ...
        if(\Auth::user()->can('edit assets'))
        {
            ...
            return view('assets.edit', compact('asset','employee','assetMasters'));
        }
        else
        {
            return redirect()->back()->with('error', __('Permission denied.'));
